...
import { ScrollVideo, type ScrollVideoProps } from "./ScrollVideo";

export default function Demo(values: ControlValues) {
  const props = values as unknown as ScrollVideoProps;
  ...
  return (
    ...
    >
      {scroller && <ScrollVideo {...props} scroller={scroller} />}
